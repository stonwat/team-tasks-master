<template>
  <div id="center">
    ...
    <div class="down">
      <div class="notice bg-color-black">
        <span>
          <icon name="chart-pie" class="text-icon"></icon>
        </span>
        <span style="font-size: 14px">待办事项</span>
        <dv-scroll-board :config="notice" />
      </div>
      <div class="percent">
        <div class="item bg-color-black">
          <span>智算使用率</span>
          <AdminPercentChart :id="rate[0].id" :tips="rate[0].tips" :colorObj="rate[0].colorData" />
        </div>
        <div class="item bg-color-black">
          <span>通算使用率</span>
          <AdminPercentChart :id="rate[1].id" :tips="rate[1].tips" :colorObj="rate[1].colorData" />
        </div>
        <div class="water">
