<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="digitalemployeeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="检出安全事件数" align="center" prop="orderError1" />
      <el-table-column label="需处置安全事件总数" align="center" prop="orderComplete1" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="检出安全事件数" prop="orderError1">
          <el-input v-model="form.orderError1" placeholder="请输入检出安全事件数" />
        </el-form-item>
        <el-form-item label="需处置安全事件总数" prop="orderComplete1">
          <el-input v-model="form.orderComplete1" placeholder="请输入需处置安全事件总数" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      this.queryParams.employeeType = '12'
    ...
    /** 导出按钮操作 */
    handleExport() {
      const filename = `网安研判智能体数据${new Date().getTime()}.xlsx`;
