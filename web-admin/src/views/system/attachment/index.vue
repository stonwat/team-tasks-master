<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="分类1.图片 2.视频" prop="type">
        <el-select v-model="queryParams.type" placeholder="请选择分类1.图片 2.视频" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="attachmentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="分类1.图片 2.视频" align="center" prop="type">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="分类1.图片 2.视频" prop="type">
          <el-select v-model="form.type" placeholder="请选择分类1.图片 2.视频">
            <el-option
              v-for="dict in dict.type.attachment"
              :key="dict.value"
              :label="dict.label"
        ...
        <el-form-item label="详情" prop="info">
          <el-input v-model="form.info" placeholder="请输入详情" />
        </el-form-item>
        <el-form-item label="链接" prop="url">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除文件类型编号为"' + ids + '"的数据项？').then(function() {
