<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="digitalemployeeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="数字员工处理的装维故障次数" align="center" prop="orderError1" />
      <el-table-column label="装维故障工单总数" align="center" prop="orderComplete1" />
      <el-table-column label="应用深度现状（百分比）" align="center" prop="orderPersent" />
      <el-table-column label="集团排名" align="center" prop="orderRank" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="数字员工处理的装维故障次数" prop="orderError1">
          <el-input v-model="form.orderError1" placeholder="未推广请填写/" />
        </el-form-item>
        <el-form-item label="装维故障工单总数" prop="orderComplete1">
          <el-input v-model="form.orderComplete1" placeholder="请输入装维故障工单总数" />
        </el-form-item>
        <el-form-item label="应用深度现状（百分比）" prop="orderPersent">
          <el-input v-model="form.orderPersent" placeholder="未推广请填写/" />
        </el-form-item>
        <el-form-item label="集团排名" prop="orderRank">
          <el-input v-model="form.orderRank" placeholder="请输入集团排名" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      this.queryParams.employeeType = '1'
    ...
    /** 导出按钮操作 */
    handleExport() {
      const filename = `装维数据_${new Date().getTime()}.xlsx`;
