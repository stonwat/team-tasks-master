<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="digitalemployeeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="多模态智能客服服务量" align="center" prop="orderError1" />
      <el-table-column label="总话务量" align="center" prop="orderComplete1" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="多模态智能客服服务量" prop="orderError1">
          <el-input v-model="form.orderError1" placeholder="请输入多模态智能客服服务量" />
        </el-form-item>
        <el-form-item label="总话务量" prop="orderComplete1">
          <el-input v-model="form.orderComplete1" placeholder="请输入总话务量" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      this.queryParams.employeeType = '6'
    ...
    /** 导出按钮操作 */
    handleExport() {
      const filename = `多模态智能体数据${new Date().getTime()}.xlsx`;
