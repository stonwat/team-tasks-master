<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="digitalemployeeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="数字员工处理的告警次数" align="center" prop="orderError1" />
      <el-table-column label="告警工单总数" align="center" prop="orderComplete1" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="数字员工处理的告警次数" prop="orderError1">
          <el-input v-model="form.orderError1" placeholder="请输入数字员工处理的告警次数" />
        </el-form-item>
        <el-form-item label="告警工单总数" prop="orderComplete1">
          <el-input v-model="form.orderComplete1" placeholder="请输入告警工单总数" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      this.queryParams.employeeType = '4'
    ...
    /** 导出按钮操作 */
    handleExport() {
      const filename = `网优数字员工数据${new Date().getTime()}.xlsx`;
