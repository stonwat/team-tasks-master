<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="digitalemployeeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="AI解构的ICT商机数" align="center" prop="orderError1" />
      <el-table-column label="BPM系统同周期提交的ICT商机量" align="center" prop="orderComplete1" />
      <el-table-column label="使用AI撰写方案的百万及以上商机" align="center" prop="orderError2" />
      <el-table-column label="BPM同周期完成方案定制的百万商机量" align="center" prop="orderComplete2" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="AI解构的ICT商机数" prop="orderError1">
          <el-input v-model="form.orderError1" placeholder="请输入AI解构的ICT商机数" />
        </el-form-item>
        <el-form-item label="BPM系统同周期提交的ICT商机量" prop="orderComplete1">
          <el-input v-model="form.orderComplete1" placeholder="请输入BPM系统同周期提交的ICT商机量" />
        </el-form-item>
        <el-form-item label="使用AI撰写方案的百万及以上商机" prop="orderError2">
          <el-input v-model="form.orderError2" placeholder="请输入使用AI撰写方案的百万及以上商机" />
        </el-form-item>
        <el-form-item label="BPM同周期完成方案定制的百万商机量" prop="orderComplete2">
          <el-input v-model="form.orderComplete2" placeholder="请输入BPM同周期完成方案定制的百万商机量" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      this.queryParams.employeeType = '10'
    ...
    /** 导出按钮操作 */
    handleExport() {
      const filename = `产数支撑智能体数据${new Date().getTime()}.xlsx`;
