<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="digitalemployeeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="数字员工处理的故障工单数" align="center" prop="orderError1" />
      <el-table-column label="故障工单总数" align="center" prop="orderComplete1" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="数字员工处理的故障工单数" prop="orderError1">
          <el-input v-model="form.orderError1" placeholder="请输入数字员工处理的故障工单数" />
        </el-form-item> 
        <el-form-item label="故障工单总数" prop="orderComplete1">
          <el-input v-model="form.orderComplete1" placeholder="请输入故障工单总数" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      this.queryParams.employeeType = '3'
    ...
    /** 导出按钮操作 */
    handleExport() {
      const filename = `隐患管控与故障处置数据_${new Date().getTime()}.xlsx`;
