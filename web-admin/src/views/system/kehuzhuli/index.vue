<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="digitalemployeeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="月活用户数" align="center" prop="orderError1" />
      <el-table-column label="电信APP月活数" align="center" prop="orderComplete1" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="月活用户数" prop="orderError1">
          <el-input v-model="form.orderError1" placeholder="请输入月活用户数" />
        </el-form-item>
        <el-form-item label="电信APP月活用户数" prop="orderComplete1">
          <el-input v-model="form.orderComplete1" placeholder="请输入电信APP月活用户数" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      this.queryParams.employeeType = '8'
    ...
    /** 导出按钮操作 */
    handleExport() {
      const filename = `AI客户助理智能体数据${new Date().getTime()}.xlsx`;
