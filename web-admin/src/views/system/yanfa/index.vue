<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="digitalemployeeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="AI生成代码行数" align="center" prop="orderError1" />
      <el-table-column label="新增代码总量" align="center" prop="orderComplete1" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="AI生成代码行数" prop="orderError1">
          <el-input v-model="form.orderError1" placeholder="请输入AI生成代码行数" />
        </el-form-item>
        <el-form-item label="新增代码总量" prop="orderComplete1">
          <el-input v-model="form.orderComplete1" placeholder="请输入新增代码总量" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      this.queryParams.employeeType = '11'
    ...
    /** 导出按钮操作 */
    handleExport() {
      const filename = `研发智能体${new Date().getTime()}.xlsx`;
