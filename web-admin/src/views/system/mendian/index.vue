<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="digitalemployeeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="自有厅调用门店宝超30次的人数" align="center" prop="orderError1" />
      <el-table-column label="自有厅总人数" align="center" prop="orderComplete1" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="自有厅调用门店宝超30次的人数" prop="orderError1">
          <el-input v-model="form.orderError1" placeholder="请输入自有厅调用门店宝超30次的人数" />
        </el-form-item>
        <el-form-item label="自有厅总人数" prop="orderComplete1">
          <el-input v-model="form.orderComplete1" placeholder="请输入自有厅总人数" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      this.queryParams.employeeType = '7'
    ...
    /** 导出按钮操作 */
    handleExport() {
      const filename = `门店宝数据${new Date().getTime()}.xlsx`;
