<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="digitalemployeeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="商机接触成功量（万）" align="center" prop="orderError1" />
      <el-table-column label="商机挖掘量（万）" align="center" prop="orderComplete1" />
      <el-table-column label="商机转化订单量（万）" align="center" prop="orderError2" />
      <el-table-column label="商机转化订单目标（万）" align="center" prop="orderComplete2" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="商机接触成功量（万）" prop="orderError1">
          <el-input v-model="form.orderError1" placeholder="请输入商机接触成功量（万）" />
        </el-form-item>
        <el-form-item label="商机挖掘量（万）" prop="orderComplete1">
          <el-input v-model="form.orderComplete1" placeholder="请输入商机挖掘量（万）" />
        </el-form-item>
        <el-form-item label="商机转化订单量（万）" prop="orderError2">
          <el-input v-model="form.orderError2" placeholder="请输入商机转化订单量（万）" />
        </el-form-item>
        <el-form-item label="商机转化订单目标（万）" prop="orderComplete2">
          <el-input v-model="form.orderComplete2" placeholder="请输入商机转化订单目标（万）" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      this.queryParams.employeeType = '9'
    ...
    /** 导出按钮操作 */
    handleExport() {
      const filename = `精准营销智能体数据${new Date().getTime()}.xlsx`;
